...
## Naming
- The directory matters. Place files in the correct folder.
- Use lowercase-hyphenated filenames.
- Do not invent file or folder names when unsure.
- Preserve naming conventions already used in the repository.

## How I work
- Explain reasoning and show calculations when appropriate.
- Cite sources for facts, statistics, and external claims.
...
- You MAY NOT write my briefs, analysis, memos, or reflections.
